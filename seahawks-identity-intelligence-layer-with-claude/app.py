"""
Seahawks Identity Intelligence — Single-Region Flask Server
Single-tenant identity resolution explainability tool for Seahawks.
"""
...
if __name__ == "__main__":
    ...
    print("\n" + "═" * 60)
    print("  SEAHAWKS IDENTITY INTELLIGENCE")
    print("═" * 60)
