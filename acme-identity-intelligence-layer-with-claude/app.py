"""
Acme Identity Intelligence — Single-Region Flask Server
Single-tenant identity resolution explainability tool for Acme.
"""
...
AI_ENGINE = None
TENANT_AGENT = None
STRATEGIST = None     # Claude/Gemini AI engine
...
if __name__ == "__main__":
    ...
    print("\n" + "═" * 60)
    print("  ACME IDENTITY INTELLIGENCE")
    print("═" * 60)
