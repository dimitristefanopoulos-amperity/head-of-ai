...
EFFICIENCY: You have a limited number of tool calls per response. Be strategic:
- Use get_identity_health ONCE to understand the tenant, then work from that data
- Do NOT size every audience separately — estimate from the total profile count
- Make ONE SQL call to validate your top recommendation, not five for every idea
- Lead with your best recommendation, offer others as follow-ups
{consumption_model}
