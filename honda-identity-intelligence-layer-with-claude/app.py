"""
Honda Identity Intelligence — Single-Region Flask Server
Single-tenant identity resolution explainability tool for Honda.
"""
...
def strategist_quick():
    """Fast-path: answer from context only, NO tool calls."""
...
if __name__ == "__main__":
    ...
    print("\n" + "═" * 60)
    print("  HONDA IDENTITY INTELLIGENCE")
    print("═" * 60)
